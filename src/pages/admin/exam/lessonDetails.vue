<template>
  ...
  >
    <v-btn @click="printQuestions">
      print
    </v-btn>
    <div class="printSection" ref="printSection">
      <Item
          v-for="question in this.quizData.questions.list"
          :source="question"
...
export default {
  ...
  methods: {
    printQuestions () {
      this.printElem(this.$refs.printSection)
    },
    printElem(elem) {
...
.printSection {
  background-image: url("../../../assets/img/printTemplate-questions.jpg");
